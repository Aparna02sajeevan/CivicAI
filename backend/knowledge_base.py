...
knowledge_base.py
-----------------
Municipal policy documents for the City of Greenville.
Covers SDG 6 (Clean Water & Sanitation) and SDG 12 (Responsible Consumption).

Each document contains metadata and a list of text chunks.
...
KNOWLEDGE_BASE = [
    ...
    # ─────────────────────────────────────────────
    {
        ...
        "chunks": [
            ...
            {
                "id": "garbage-3",
                "text": "Greenville provides a 96-gallon black bin for general garbage and a 96-gallon blue bin for recyclables. New residents can request bins at no cost at the Public Works Department, 100 City Hall Plaza, or online at greenville.gov/bins. Replacement bins cost $35 each. Extra garbage bags are available at grocery stores for $3 each."
            },
            {
                "id": "garbage-4",
                "text": "Collection is suspended on the following public holidays: New Year's Day, Memorial Day, Independence Day, Labor Day, Thanksgiving Day, and Christmas Day. When a holiday falls on or before your collection day in that week, collection shifts to the next day."
            },
            {
                "id": "garbage-5",
                "text": "If your bin was not collected on your scheduled day, report a missed collection at greenville.gov/missed-pickup or call 555-GRN-TRASH by 5:00 PM. Leave the bin at the curb and crews will return within 24 hours. Missed collections due to improper bin placement are not eligible for re-collection."
            },
        ],
    },
    {
        ...
        "chunks": [
            ...
            {
                "id": "recycling-4",
                "text": "Greenville offers food scrap composting collection for residents enrolled in the Green Cart Program. A 35-gallon green bin is provided for food scraps (fruit, vegetables, meat, dairy, eggshells) and yard waste. Green Cart pickup occurs on the same day as regular collection. Enroll at greenville.gov/green-cart."
            },
            {
                "id": "recycling-5",
                "text": "Residents can earn Greenville Green Points for recycling. Points are tracked via the Greenville City app by scanning your account QR code on your bin. Accumulated points can be redeemed for discounts at local businesses, free park passes, or donated to local environmental nonprofits."
            },
        ],
    },
    {
        ...
        "chunks": [
            ...
            {
                "id": "ewaste-2",
                "text": "E-waste can be dropped off free of charge at the Greenville E-Waste Recycling Centre, 201 Tech Park Road, open Tuesday–Saturday 9am–4pm. Items accepted: computers, monitors, televisions, mobile phones, tablets, keyboards, mice, cables, printers, and small electronics."
            },
            {
                "id": "ewaste-3",
            ...
            {
                "id": "ewaste-5",
                "text": "Businesses generating e-waste must use a licensed e-waste recycler registered with the State Environmental Protection Agency. A list of certified business e-waste recyclers is available at greenville.gov/business-ewaste. Businesses may NOT use residential drop-off facilities."
            },
        ],
    },
    {
        ...
        "chunks": [
            ...
            {
                "id": "bulk-2",
                "text": "Items accepted for bulk pickup: sofas, chairs, beds and mattresses, dressers, desks, tables, non-functional appliances (stoves, washers, dryers, refrigerators with freon removed), rugs (rolled and tied), and bundled yard waste (branches cut to 4-foot lengths). Maximum 5 items per pickup appointment."
            },
            {
                "id": "bulk-3",
            ...
            {
                "id": "bulk-4",
                "text": "Place bulk items at the curb by 6:00 AM on your scheduled pickup day. Do not place items out more than 24 hours before your appointment. Crews cannot enter private property. Items must be placed separately — do not bag or bind multiple items together unless specified (e.g., bundled branches)."
            },
        ],
    },
    {
        ...
        "chunks": [
            {
                "id": "hazardous-1",
                "text": "Household Hazardous Waste (HHW) includes paint, pesticides, fertilizers, pool chemicals, motor oil, antifreeze, batteries, fluorescent bulbs, propane tanks, and cleaning solvents. These must NEVER be placed in regular garbage, poured down drains, or dumped on the ground. Improper disposal is illegal and harmful to waterways."
            },
            {
                "id": "hazardous-2",
                "text": "The Greenville Household Hazardous Waste Facility is located at 45 Environmental Way and is open every Saturday from 8am–3pm, year-round. No appointment needed. Accepted free of charge for residential quantities. Limit 15 gallons or 125 lbs per visit."
            },
            {
                "id": "hazardous-3",
                "text": "Latex paint can be dried out (leave lid off or add cat litter to solidify) and placed in regular garbage once fully solid. Oil-based paint must go to the HHW Facility. Unused paint in good condition can be donated at the Greenville Paint Exchange, open Saturdays 9am–1pm at the HHW Facility."
            },
            {
                "id": "hazardous-4",
                "text": "Household batteries (AA, AAA, C, D, 9V) can be dropped off at over 40 locations across Greenville including libraries, community centers, and hardware stores. The full drop-off list is at greenville.gov/battery-drop. Car batteries are accepted at all auto parts stores and the HHW Facility."
            },
            {
                "id": "hazardous-5",
                "text": "Sharps (needles, lancets, syringes) are medical waste requiring special disposal. Sharps collection boxes are available at all Greenville pharmacies. Never place loose sharps in trash or recycling. Mail-back sharps disposal programs are available for $10 at greenville.gov/sharps. Improper sharps disposal carries a $250 fine."
            },
        ],
    },
    # ─────────────────────────────────────────────
    ...
    # ─────────────────────────────────────────────
    {
        ...
        "chunks": [
            {
                "id": "stormwater-1",
                "text": "Stormwater drains and catch basins in Greenville are maintained by the Public Works Department. To report a blocked or damaged storm drain, call 555-GRN-DRAIN or submit a report online at greenville.gov/drain-report. Crews inspect reported blockages within 72 hours."
            },
            {
                "id": "stormwater-2",
                "text": "Never dump anything into storm drains. Storm drains lead directly to local waterways and the bay — they are NOT connected to the sewage treatment system. Illegal dumping into storm drains includes motor oil, paint, chemicals, grass clippings, pet waste, and food waste. Fines range from $500 to $10,000."
            },
            {
                "id": "stormwater-3",
                "text": "If your property experiences flooding during heavy rain, contact the Stormwater Division at 555-GRN-FLOOD. For life-threatening flooding, call 911 immediately. Greenville maps flood-prone areas annually — check your property's flood zone at greenville.gov/flood-map."
            },
            {
                "id": "stormwater-4",
                "text": "Greenville offers a Green Infrastructure Rebate of up to $1,000 for eligible stormwater management installations (rain gardens, bioswales, permeable pavement). Apply at greenville.gov/green-infrastructure. Free design consultations are available from the Stormwater Division."
            },
        ],
    },
    # ─────────────────────────────────────────────
    ...
    # ─────────────────────────────────────────────
    {
        ...
        "chunks": [
            {
                "id": "sdg-1",
                "text": "Greenville's 2030 Sustainability Plan commits to SDG 6 (Clean Water and Sanitation) by ensuring 100% safe water access, eliminating sewage overflows, and reducing per-capita water consumption by 20%. Progress is tracked annually at greenville.gov/sdg."
            },
            {
                "id": "sdg-2",
                "text": "Under SDG 12 (Responsible Consumption and Production), Greenville targets a 50% waste diversion rate by 2030 (currently at 38%). Key initiatives: expanding composting, increasing recycling education, eliminating single-use plastics in city operations, and partnering with local businesses on waste reduction."
            },
            {
                "id": "sdg-3",
                "text": "The Greenville Zero Waste School Program educates K-12 students on waste reduction, composting, and water conservation. Schools that achieve 75% waste diversion earn the Green School Certification and a $500 grant. Teachers can request a free waste audit kit at greenville.gov/schools-green."
            },
            {
                "id": "sdg-4",
                "text": "Greenville's Fix-It Clinic is a free monthly event where volunteers help residents repair broken electronics, clothing, furniture, and small appliances to extend their life and reduce waste. Events are held the second Sunday of each month at the Downtown Community Centre, 10am–2pm."
            },
        ],
    },
    # ─────────────────────────────────────────────
    ...
    # ─────────────────────────────────────────────
    {
        ...
        "chunks": [
            {
                "id": "complaints-1",
                "text": "Greenville operates a unified 311 Customer Service Centre for all non-emergency municipal requests. Reach 311 by calling 311 (within city limits) or 555-311-CITY (outside), texting 'GREENVILLE' to 31139, using the Greenville City app, or visiting greenville.gov/311. Hours: Mon–Fri 7am–8pm, Sat 8am–5pm."
            },
            {
                "id": "complaints-2",
                "text": "To file a formal complaint about any city service (water, waste collection, stormwater), submit a written complaint at greenville.gov/formal-complaint or mail to City Clerk, 1 City Hall Plaza, Greenville. Formal complaints receive a written response within 15 business days. Escalate to City Ombudsman at 555-OMB-CITY."
            },
            {
                "id": "complaints-3",
                "text": "To report illegal dumping or littering in Greenville, call 555-GRN-DUMP or use the anonymous online report form at greenville.gov/illegal-dumping. Include photos and the location if possible. Reports are investigated within 5 business days. The city offers a $200 reward for information leading to conviction of illegal dumpers."
            },
            {
                "id": "complaints-4",
                "text": "Environmental violations (illegal discharge, pollution, hazardous dumping) can be reported to the Greenville Environmental Enforcement Division at 555-ENV-GRNV or env.enforcement@greenville.gov. For immediate environmental emergencies (chemical spills, sewage overflow), call the 24-hour emergency line at 555-911-ENV."
            },
        ],
    },
]

# Flatten all chunks with metadata for easy access
def get_all_chunks():
    """Return a flat list of (chunk_dict, doc_metadata) tuples."""
    result = []
